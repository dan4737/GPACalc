...
# Course details
COURSES = {
    "Data Analytics": 40,  # Course name and total credit hours
    "Cyber Security": 40,
    "Personal Support Worker":57 
...
def calculate():
    ...
    # Get total credit hours for the selected course
    total_course_credits = COURSES.get(selected_course, 0)
